	...
	// Default server is localhost (127.0.0.1) on port 4723
		...
		*/
		...
		public void testScroll() throws InterruptedException{
			...
			Thread.sleep(500);
			driver.scrollTo("West");
			driver.findElement(By.name("West")).tap(1, 25);
			Thread.sleep(1000);
			driver.navigate().back();
			driver.scrollTo("Average fuel economy");
			driver.findElement(By.name("Average fuel economy")).tap(1, 25);
			Thread.sleep(5000);
		}
